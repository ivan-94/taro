# [](https://github.com/NervJS/taro/compare/v2.2.13...v) (2020-09-03)


### Bug Fixes

* **redux-h5:** 修复 React 引用问题i ([c34190a](https://github.com/NervJS/taro/commit/c34190aaa6980822fb0e11d6c2d8d0b7e693fba4))
* **router:** 优化标题设置 ([7500169](https://github.com/NervJS/taro/commit/750016972c41d989f645951b19b318dc32c4d65d))
* **taro-router:** componentDidShow 调用没有绑定 context ([296911e](https://github.com/NervJS/taro/commit/296911ebfb046966fe02c7ccf8a8611fa956e5c8))
...
* rewrite block to fragment ([11849cc](https://github.com/NervJS/taro/commit/11849ccacb79aad55fd112b093e358eda5bfb15f))
...
* 修复 taro-router 在 react 下无法执行 ([ff6cb16](https://github.com/NervJS/taro/commit/ff6cb16eab8cdf700208fe87938e9da5f0e0670c))
* 规范化 style props 禁止使用 字符串 ([17a6512](https://github.com/NervJS/taro/commit/17a6512b42058e5c849d6f6eac1ce0dfee9e031c))
...
* **transformer-wx:** 函数组件添加标识 ([92a30dd](https://github.com/NervJS/taro/commit/92a30ddc8f7ecb3fa7e87ae08a8147eb21f5fe0e))
* taro-router getCurrentPages 修复 ([a2cd789](https://github.com/NervJS/taro/commit/a2cd78922072af373ba474bf6c0a041e2b11abed))
* **transformer-wx:** 函数式组件转换为类组件时，添加标识 ([c8fa643](https://github.com/NervJS/taro/commit/c8fa643acb5c4e0e3ab51d75cdfaaaf175cce77c))
* 更新 react-redux ([411a25a](https://github.com/NervJS/taro/commit/411a25a1872fcb34e947db678a8ea55bfe09c021))
* **taro-router:** 新增 PageContext ([9d0e85d](https://github.com/NervJS/taro/commit/9d0e85dde7295ed09a29053bcfcfacb391004863))
...
* **taro-weapp:** 支持 onAddToFavorites ([5e75b02](https://github.com/NervJS/taro/commit/5e75b024b9fb07bd5a3073e85d1f95f7bed970dd))
...
* route redirect show page fix [#6625](https://github.com/NervJS/taro/issues/6625) ([c35d577](https://github.com/NervJS/taro/commit/c35d577e3fbe20524ed3b2b7547bf0255bd798d2))
...
* **cli:** 模板初始化时changeExt 无效 ([#6464](https://github.com/NervJS/taro/issues/6464)) ([b64d01f](https://github.com/NervJS/taro/commit/b64d01f4c17f1ffdb99679f27ec168769d55ede9))
...
* **h5:** 修复uploadFile上传的是个blob对象的问题 ([2cd230c](https://github.com/NervJS/taro/commit/2cd230c5b8dbb467a6cb4815f1c541b2f5f779cf))
...
* code format ([320c411](https://github.com/NervJS/taro/commit/320c411bdc2b1cd5f0de80a3af51c6d4cf87aece))
...
* **redux:** 快速dispatch redux actions情况下无法正确记录prevProps ([#5829](https://github.com/NervJS/taro/issues/5829)) ([e0166b5](https://github.com/NervJS/taro/commit/e0166b508ed997cc0a2bddcb478a5f4b1888ffe5))
...
* **mini-runner:** 解决使用 addChunkPages 时子包组件插入公共引用的问题 ([0cbce17](https://github.com/NervJS/taro/commit/0cbce179774b2b1be9a5eb3a7b6da5dd0d535215))
...
* **mini-runner:** 优化 npm 文件加载顺序 ([b22c0fa](https://github.com/NervJS/taro/commit/b22c0fa918eaacee75f91189feb604ced0945b36))
...
* **mini-runner:** 修复使用 cnpm 等安装器安装依赖时引用 taro-ui 报错的问题，[#5278](https://github.com/NervJS/taro/issues/5278) ([9480496](https://github.com/NervJS/taro/commit/94804969688ab448f72f485e8783055acb0304ec))
* **mini-runner:** 修复页面文件 watch 时修改的问题，close [#5293](https://github.com/NervJS/taro/issues/5293) ([309f066](https://github.com/NervJS/taro/commit/309f066ea067900e5e56284ab2d03c92ec1a7765))
* **mini-runner:** 添加 mini.compile 配置 ([949fd37](https://github.com/NervJS/taro/commit/949fd370a37fcb6a34b4cbcef1cecd117a8a7877))
* **weapp/qq:** 微信、qq小程序 request 并发数改为 10，fix [#5291](https://github.com/NervJS/taro/issues/5291) ([474c7aa](https://github.com/NervJS/taro/commit/474c7aaf78fb8c46e819730758e553a4faeaa427))


### Reverts

* 去除版本运行提示 ([3b50289](https://github.com/NervJS/taro/commit/3b50289796e2914223d7828e8d10644c414fd68e))
* 恢复运行时的版本提示 ([b006895](https://github.com/NervJS/taro/commit/b00689573a7ca516f5b0961344da173ca9cfd5f0))
...
* **alipay:** 支付宝小程序分包下 compid 应该挂全局 ([30fd22c](https://github.com/NervJS/taro/commit/30fd22c2a55bf110e8a7d7b3a0353cb1744c749b))
* **mini:** 修复 requset API 不触发 success 和 fail 的问题，close [#5271](https://github.com/NervJS/taro/issues/5271) ([258cd78](https://github.com/NervJS/taro/commit/258cd78f4f6fc6c1079c7094aed1abfe455ee9df))
* **weapp:** 修复 Taro.cloud 部分函数返回错误的类型定义 ([#5270](https://github.com/NervJS/taro/issues/5270)) ([de04d79](https://github.com/NervJS/taro/commit/de04d794f2a96a4a92a8b5ada50cbf32ce1894c5))
* **weapp:** 导出 wx.env 对象，增加 Taro.env.USER_DATA_PATH 类型定义 close [#3710](https://github.com/NervJS/taro/issues/3710) ([a9c0c09](https://github.com/NervJS/taro/commit/a9c0c09ce48fdda25029b60aaef107bf2dd9b7cf))
* **weapp:** 添加微信小程序 webp 属性和修复函数式组件缺少的 externalClasses 类型 ([#5273](https://github.com/NervJS/taro/issues/5273)) ([2dd00dc](https://github.com/NervJS/taro/commit/2dd00dcd4a3611f01144b61024c2edbba0ec1f00))
...
* **cli:** 2.0.0-beta.8. 编译RN报错 'babel' of undefined close [#5093](https://github.com/NervJS/taro/issues/5093) ([89a5ab7](https://github.com/NervJS/taro/commit/89a5ab7a94870c27bffcf44fd720dacb4fc244b4))
* **cli:** 修正快应用依赖项安装命令在windows不兼容问题 ([#4954](https://github.com/NervJS/taro/issues/4954)) ([df097ef](https://github.com/NervJS/taro/commit/df097ef96ef7bcd980176e135b3588229e73f59b))
* **cli:** 切换默认模板请求源 ([84f75b8](https://github.com/NervJS/taro/commit/84f75b85c478f2e6a4df9d5af6124bbe4f3e7ada))
* **cli:** 增加运行提示 ([34a75a8](https://github.com/NervJS/taro/commit/34a75a8c2a906c138338abbb9e400d12cd9922ce))
* **cli:** 插件编译失败，close [#5149](https://github.com/NervJS/taro/issues/5149) ([fb60772](https://github.com/NervJS/taro/commit/fb607725164ff5d6dce611497298698e07aa2ce1))
* **cli:** 更新默认模板 ([cb50115](https://github.com/NervJS/taro/commit/cb50115f7c57c055979498b54a967f7e49483e9d))
* **cli:** 解决 cli 编译时缺少 @types/react 依赖问题 ([#4997](https://github.com/NervJS/taro/issues/4997)) ([7ea6a44](https://github.com/NervJS/taro/commit/7ea6a443ae3ed7431b69869850db2c86de42e588))
* **components-qa:** 改进 button 动画效果展示，引入 css 属性描述文件 ([#4898](https://github.com/NervJS/taro/issues/4898)) ([f868bf5](https://github.com/NervJS/taro/commit/f868bf574af16ac88061bc88e45e97a704e6b4d6))
* **mini-runner:** 优化 watch 时文件编译速度 ([376138b](https://github.com/NervJS/taro/commit/376138b5ba4a7434fdcedd1c80c7e938f4737fa1))
* **mini-runner:** 修复 defineConstants 小程序表现与 H5 不一致问题 close [#5078](https://github.com/NervJS/taro/issues/5078) ([6cd3fbe](https://github.com/NervJS/taro/commit/6cd3fbec17acbffe5a75323b33a9fdae0ccaaa58))
* **mini-runner:** 修复 sass 变量失效的问题，close [#4893](https://github.com/NervJS/taro/issues/4893) ([60e522a](https://github.com/NervJS/taro/commit/60e522abfc811a79d88bdf865e86c9057a7a286e))
* **mini-runner:** 修复 watch 时修改报错的问题 ([605e68a](https://github.com/NervJS/taro/commit/605e68a33c95b61dbc788cd2251d1cac7d2d0f80))
* **mini-runner:** 修复 watch 时修改页面导致组件无法及时更新的问题 ([a2332f8](https://github.com/NervJS/taro/commit/a2332f89846a311c3601fc7ba7e48eb3c1ccbac6))
* **mini-runner:** 修复 watch 时增加组件文件的 bug，close [#5140](https://github.com/NervJS/taro/issues/5140) ([c889d55](https://github.com/NervJS/taro/commit/c889d552e615e2d35507bb3978fde4f26886acb7))
* **mini-runner:** 修复 watch 时文件报错导致无法重新编译的问题，fix [#4949](https://github.com/NervJS/taro/issues/4949) ([57f049d](https://github.com/NervJS/taro/commit/57f049d2fd03a25e9c49f532c4df0001e430d7aa))
* **mini-runner:** 修复 windows 下编译后 taro 引用错误的问题 ([ef7431d](https://github.com/NervJS/taro/commit/ef7431d7fd65788e36896dc3e69bad069e63549d))
* **mini-runner:** 修复 yarn workspace 模式下引入 npm 中组件出错的问题 ([a5114c4](https://github.com/NervJS/taro/commit/a5114c4047d09848b56ff282253b13837e69f136))
* **mini-runner:** 修复使用 preval 报错的问题 ([1c68f6c](https://github.com/NervJS/taro/commit/1c68f6c30ef76578d05e188a0d432c1071f7af91))
* **mini-runner:** 修复分包页面丢失的问题 ([fbdbb70](https://github.com/NervJS/taro/commit/fbdbb70ecee0149b34abe0dc2d413c9cde6120f8))
* **mini-runner:** 修复包未安装不报错的问题 ([5552fa2](https://github.com/NervJS/taro/commit/5552fa215c750c3d579ea2cd12951ccba1447862))
* **mini-runner:** 修复多端文件引用的问题，close [#5175](https://github.com/NervJS/taro/issues/5175) ([0c243ac](https://github.com/NervJS/taro/commit/0c243accd15586d1c76e703637efc72e28faa5d1))
* **mini-runner:** 修复对 alias 的支持 ([3786d6b](https://github.com/NervJS/taro/commit/3786d6b6d58e1c64a1c53cf084365728728a55dc))
* **mini-runner:** 修复小程序编译时样式中引用静态资源转换为 base64 ([c871702](https://github.com/NervJS/taro/commit/c871702cf6e838330e2051f6afa9945166445056))
* **mini-runner:** 修复引用原生组件报错的问题 ([0632783](https://github.com/NervJS/taro/commit/0632783cb699545a259ae67378536bcd2039c150))
* **mini-runner:** 修复引用原生组件编译后样式文件缺失的问题 ([cd0f55a](https://github.com/NervJS/taro/commit/cd0f55a3ea855ff03f086d6419a1b7c150b61627))
* **mini-runner:** 修复生产打包时公共样式无法插入的问题 ([63d22d2](https://github.com/NervJS/taro/commit/63d22d2e69962be0ba866c2ea5fb7f3bc1dd9621))
* **mini-runner:** 修复组件 watch 时改动不生效的问题 ([51a0cf1](https://github.com/NervJS/taro/commit/51a0cf14b9c1d32f49824d8d0012ce3805705436))
* **mini-runner:** 修复静态资源引用的 bug ([07e8c66](https://github.com/NervJS/taro/commit/07e8c664885f39cd7656c521d66dc0c1c1d68eeb))
* **mini-runner:** 修复页面 hooks config 失效问题 ([545f327](https://github.com/NervJS/taro/commit/545f3275acb2b0d5131cbafe007647e95db3c7c3))
* **mini-runner:** 修正快应用pages中ux文件未正确生成问题 ([#4969](https://github.com/NervJS/taro/issues/4969)) ([e1e1c79](https://github.com/NervJS/taro/commit/e1e1c7900e6740212b2ca6aa00c6f40f02053a20))
* **mini-runner:** 加入 preval 支持 ([5b771ff](https://github.com/NervJS/taro/commit/5b771ff2bd18dabcb9ab67be10fd62f2661f5cf5))
* **mini-runner:** 增加快应用公共属性的自动更新，优化button动画直接调用 ([#5044](https://github.com/NervJS/taro/issues/5044)) ([ab3279a](https://github.com/NervJS/taro/commit/ab3279aefdf25ae47008c05e36331b109146ecde))
* **mini-runner:** 快应用页面路径编译错误 ([024615a](https://github.com/NervJS/taro/commit/024615a9af043d7bde6f516cfec7cbcf5a08064d))
* **mini-runner:** 支持自定义 tabBar ([44e218f](https://github.com/NervJS/taro/commit/44e218fbd8398d85a2996c608ecde079b618f118))
* **mini-runner:** 暴露 commonChunks 配置以供自定义公共 chunks 生成 ([8f6bdee](https://github.com/NervJS/taro/commit/8f6bdee5928f1cd52d4b8532268fabc9248caa0c))
* **mini-runner:** 更新编译时提示 ([3bc039a](https://github.com/NervJS/taro/commit/3bc039a8c271cc698be38611aacbff87e90ed918))
* **mini-runner:** 移除无用代码 ([6b22c21](https://github.com/NervJS/taro/commit/6b22c21b75b361f9aa3a41166560ba784246329e))
* **mini-runner:** 组件中 $componentPath 路径生成不对 ([978cef0](https://github.com/NervJS/taro/commit/978cef0820e5948d44226d8f738267e924f7f5ef))
* **mini-runner:** 组件引入支持统一从一个入口文件中引入 ([1dd5443](https://github.com/NervJS/taro/commit/1dd54437b1c2dc9cb6fe9f364ff63804cc375c38))
* **mini-runner:** 组件引用支持 import as 语法 ([0f0d834](https://github.com/NervJS/taro/commit/0f0d83480ebd8db2946c27da0e6c556ee8497c93))
* **mini-runner:** 编译时移除组件文件引用，遗漏了 npm 包中组件，close [#5139](https://github.com/NervJS/taro/issues/5139) ([ea7023b](https://github.com/NervJS/taro/commit/ea7023b6cfc824a73b164b355f707ec748370de1))
* **mini-runner:** 编译时需要移除对组件文件的引用 ([acdf816](https://github.com/NervJS/taro/commit/acdf8168f01c30327e02f5a04e0193ac65af457a))
* **mini-runner:** 降低 babel-plugin-preval 版本以保证使用 async await 时不报错 ([a423810](https://github.com/NervJS/taro/commit/a42381042d0ce595f92b7aba5f3961e502437247))
* **taro:** update getStorage return typings ([#5170](https://github.com/NervJS/taro/issues/5170)) ([05438db](https://github.com/NervJS/taro/commit/05438db7226d48298474186bd54dfce1c52833b0))
* **taro:** 增加递归查找中止条件，修正拼写错误 ([#5045](https://github.com/NervJS/taro/issues/5045)) ([a097a37](https://github.com/NervJS/taro/commit/a097a37d45dc293ef02406b63b0e3f629a662a3f))
* **taro-alipay:** 兼容支付宝和微信 request 回调函数 ([d59d792](https://github.com/NervJS/taro/commit/d59d7927dc116fde946c5543a2824fcc51deabe6))
* **taro-cli:** update package list 新增 @tarojs/mini-runner，对列表排序 ([d4c6801](https://github.com/NervJS/taro/commit/d4c68014e6aa04c281bc3255eddec889a91e1898))
* **taro-runner-utils:** 优化代码，修复找不到类型定义的问题 ([7c46d85](https://github.com/NervJS/taro/commit/7c46d85c7549bb125044d429e17e9ef794b0410d))
* **types:** add enableFlex to ScrollViewProps ([#5142](https://github.com/NervJS/taro/issues/5142)) ([e2c262c](https://github.com/NervJS/taro/commit/e2c262ca36417df6fc29a4736995ada25c8ff083))
* for video objectFit ([500654e](https://github.com/NervJS/taro/commit/500654e20267ea865569312f93d78fe980f145e5))
* use rimraf instead of rm to fixed Windows build error ([5afba17](https://github.com/NervJS/taro/commit/5afba17b39be9f8ea7b2249969ab013a66cf15c7))
* **taro-webpack-runner:** 修复 sassLoaderOption 未定义的问题 ([32979c1](https://github.com/NervJS/taro/commit/32979c1a2e59dda454b9a03778926707e4347045))
* **template:** 更新 Taro 2.0 的模版和下载地址 [#4837](https://github.com/NervJS/taro/issues/4837) ([69151e3](https://github.com/NervJS/taro/commit/69151e32a505387ab315b331a643f9e4b98dc466))
* somethings no need ([2f81593](https://github.com/NervJS/taro/commit/2f81593d7c6267ae939fa4e17e1b22d17d989930))
...
* **cli:** lerna 加入 taro-mini-runner && 接入 webpack 生成小程序文件 ([8c80418](https://github.com/NervJS/taro/commit/8c80418014321f4e19dc6d1552d6b05b458a86c9))
...
* **cli:** 修复 doctor 对 config 的检测 ([7b097b7](https://github.com/NervJS/taro/commit/7b097b7d976d7297dac0a4a5f77a83041b8155a4))
* **cli:** 修复 watch 时文件修改不对的问题 ([1620d9d](https://github.com/NervJS/taro/commit/1620d9deb8e20cb9ca0a36edabc98bbda7a8cb6c))
* **cli:** 修复代码合并的问题 ([8125a37](https://github.com/NervJS/taro/commit/8125a3732f4fdb563149d5a1e46b69dcc6782b85))
* **cli:** 修复目录创建 ([10eef8c](https://github.com/NervJS/taro/commit/10eef8caf01cbf420980c6576f7c081e3cd848b1))
* **cli:** 修复配置文件中读取不到 process.env.TARO_ENV 的问题 ([e245932](https://github.com/NervJS/taro/commit/e245932a43d1eda2fe667dbae635076ffdf48149))
* **cli:** 支持引用 node_modules 中组件 ([2ecfc68](https://github.com/NervJS/taro/commit/2ecfc68dcc142fb40990f2defe609a4c92933489))
* **cli:** 普通文件经过编译器编译必须传入 isNormal ([687cd65](https://github.com/NervJS/taro/commit/687cd65f0bbe07bea1a7b4f5a58ffc883315f75f))
* **cli:** 更新默认模板 ([bb025b8](https://github.com/NervJS/taro/commit/bb025b80732ae125376ab9aec0d70b70bfff2be9))
* **cli:** 清理代码 ([bd31812](https://github.com/NervJS/taro/commit/bd31812d16c6ec515bba09e15da4af1b01306e86))
* **cli:** 编译器参数调整 ([9d239d7](https://github.com/NervJS/taro/commit/9d239d7f6b26311de273d7de2af669f0250c76d2))
* **components:** h5 image 删除无关代码 ([#4998](https://github.com/NervJS/taro/issues/4998)) ([d45da9c](https://github.com/NervJS/taro/commit/d45da9c6cf1337bb2f21d92ad4436f6726c1b513))
* **components:** 修复 Image 组件在 react 环境下报错的问题 ([e7ad2b8](https://github.com/NervJS/taro/commit/e7ad2b89d0e24a8ad5e3fc1e78f7bab274d865cc))
* **components-qa:** 修复页面 onReachBottom 事件不触发的问题 ([7209a7a](https://github.com/NervJS/taro/commit/7209a7a31caa47886a2f15ed2ba567ea59d72c31))
* **jd:** 修复合并代码导致的京东小程序的编译问题 ([890ae14](https://github.com/NervJS/taro/commit/890ae1419633b8b147bfd8c2debbec6706f113f8))
* **mini-runner:** npm 中文件不会经过 taro 包替换操作 ([95af513](https://github.com/NervJS/taro/commit/95af513a728133951fe6120c7aa7666de484a0f9))
* **mini-runner:** 优化 webpack 编译时样式处理 ([6b8e540](https://github.com/NervJS/taro/commit/6b8e54070f983658484d2cf560b30e61f0003af7))
* **mini-runner:** 修复 builder 的 hooks 调用 ([1585b5b](https://github.com/NervJS/taro/commit/1585b5b4ede9fd159512b95c5529ebcb35ea3e74))
* **mini-runner:** 修复 tabbar 编译及组件 watch 的问题 ([4f7e02b](https://github.com/NervJS/taro/commit/4f7e02b8d4f858d0caf789e5e2428955617fde53))
* **mini-runner:** 修复 watch bug ([c4ec619](https://github.com/NervJS/taro/commit/c4ec6198582b3d710389885c5ed8b2a6ad4c3ea7))
* **mini-runner:** 修复对 css modules 的支持 ([993ef03](https://github.com/NervJS/taro/commit/993ef0365791b4140e289d47726b72032740bda2))
* **mini-runner:** 修复小程序编译报错 ([56dd736](https://github.com/NervJS/taro/commit/56dd736d7cf8f2b44ee6f8d6c130381a425a83a0))
* **mini-runner:** 修复引用 npm 中组件间存在依赖时依赖路径解析错误的问题 ([c4df170](https://github.com/NervJS/taro/commit/c4df17036b981e8107ddf7ba6c2bded5d3d9fff9))
* **mini-runner:** 修复快应用打包报错的问题 ([ae35458](https://github.com/NervJS/taro/commit/ae3545883395b69ba8b65c67014002eb5973c2d5))
* **quickapp:** pull-down-refresh page-scroll ([63779bd](https://github.com/NervJS/taro/commit/63779bdd21063caf445536c172a3f407adb18766))
* position linter for quickapp 1060+ ([37fd917](https://github.com/NervJS/taro/commit/37fd917397823702b8de185c0f19729142857111))
* quickapp api upload from docs ([f7e9666](https://github.com/NervJS/taro/commit/f7e9666acb3893096e5b27b767e02b2d7dcea670))
* **mini-runner:** 修复快应用编译后页面标题展示不正确的问题 ([e845092](https://github.com/NervJS/taro/commit/e8450923bb2cfb56eb3af2dbe3a132aae4f009b9))
* **mini-runner:** 修复普通小程序编译的问题 ([df34585](https://github.com/NervJS/taro/commit/df34585c1b538001dd129a594eb02a4a672142b3))
* **mini-runner:** 加上文件编译提示 ([1203737](https://github.com/NervJS/taro/commit/1203737a8629806c0edfcb3f1895bb3e70078588))
* **mini-runner:** 只有 taro 的包不能经过依赖包名替换 ([477e831](https://github.com/NervJS/taro/commit/477e8318fdacbbecd385c18a5bee02ae68ef19c3))
* **mini-runner:** 打包优化，引用自 npm 包中的组件不抽离至 vendors 中 ([4ecdb24](https://github.com/NervJS/taro/commit/4ecdb24474d1934e0668d84f741af2b40f70575b))
* **mini-runner:** 提前解析快应用页面 ([7d5caa2](https://github.com/NervJS/taro/commit/7d5caa243fb635604946f3752d25c21bbf93f17c))
* **mini-runner:** 支持快应用编译后模板与样式的检测 ([7727c85](https://github.com/NervJS/taro/commit/7727c85c49c01244042e8ccbc1731aec439863e7))
* **taro:** 修复快应用下拉刷新问题 ([a3c0fed](https://github.com/NervJS/taro/commit/a3c0fed86251b162cfeb579c57d7c266ab24756e))
* **taro:** 小程序 webpack 编译静态文件路径 ([2adeaaf](https://github.com/NervJS/taro/commit/2adeaafa0f76f46e82145bb1abb405abf3374b7a))
* **taro-quickapp:** 修复快应用事件绑定异常问题 ([cccf7ee](https://github.com/NervJS/taro/commit/cccf7eec258c218eb215dbccde35a6fec8c450a8))
* pxtransform disable on quick-app ([c50e0ff](https://github.com/NervJS/taro/commit/c50e0ffb3d8dca0b779128c9830e73ad64e1b1e5))
* **transformer:** 修复测试用例 ([5b2f988](https://github.com/NervJS/taro/commit/5b2f988feaa20f03225e9a703fd8a6f5edae5411))
* **transformer:** 修复错误类型 ([85ed48f](https://github.com/NervJS/taro/commit/85ed48fd0ad3130d61468128a7608ee24a4ed4d1))
* **transformer:** 支持直接 import  default ([080e3f6](https://github.com/NervJS/taro/commit/080e3f6383b3cd58f24b16fbfc31ba91be8934b1))
...
* **webpack:** 修复文件压缩的问题 ([a1ab5eb](https://github.com/NervJS/taro/commit/a1ab5ebe5bacda8f302f72bd5c020adbf9b0fc66))
* 修复h5独有属性类型 ([2d3a3a0](https://github.com/NervJS/taro/commit/2d3a3a05689c1dc8627856bd92a75f88bd6fc599))


### Features

* **rn:** taro React Native 依赖由 0.55.4 升级到 0.59.9 ([bf98078](https://github.com/NervJS/taro/commit/bf98078fdb8ecfd1ac65f1099163912b0d4e4933))
* **taro-runner-utils:** 添加单元测试和优化注释 ([0f65793](https://github.com/NervJS/taro/commit/0f6579306a1328a4175d26ba69ba965361c34045))
* webpack-runner 和 mini-runner 代码优化 ([991588d](https://github.com/NervJS/taro/commit/991588dd24936f5f6d05e6972f7c313e54823c3a))
* **cli:** cli 支持事件 && 小程序编译配置向 H5 看齐 ([4d74ae4](https://github.com/NervJS/taro/commit/4d74ae4c2b1b99a0267ff3e01122ce26d4f873a5))
* **cli:** 借助 tapable 改造 ([9e4dd18](https://github.com/NervJS/taro/commit/9e4dd18d072578afeff5b42fa3c811b21217aa76))
* **cli:** 增加 tapable 包 ([aed9a00](https://github.com/NervJS/taro/commit/aed9a00f626a1675a447a27e7507a3da7c4ee55a))
* **cli:** 将 app/页面/组件 添加到入口文件进行编译 ([bc78f1d](https://github.com/NervJS/taro/commit/bc78f1daada267c487f8a2d921ef58b37c7ad1a4))
* **cli:** 尝试接入 webpack 来编译各端小程序 ([f273db6](https://github.com/NervJS/taro/commit/f273db664e20dcbe5c648f1e0314bb5dbd996958))
* **cli:** 拆分逻辑到 loader ([8d9e080](https://github.com/NervJS/taro/commit/8d9e080df4cfb014872d9e0dabd4a511a88d3b89))
* **cli:** 调整文件编译 ([f192fc2](https://github.com/NervJS/taro/commit/f192fc2e5cd489d0ee70b3936ab2e918a8d7246a))
* **components-qa:** 增强快应用button组件，增加属性判断及点击变色等 ([#4882](https://github.com/NervJS/taro/issues/4882)) ([06b7cdf](https://github.com/NervJS/taro/commit/06b7cdf55b24f592ca2073bb52694a18e6ae857d))
* **docs:** 更新 2.0 版本使用 async-await 的文档 [#4837](https://github.com/NervJS/taro/issues/4837) ([116805e](https://github.com/NervJS/taro/commit/116805e69f95781e6b5f985164c19715db53e49b))
...
* **mini-runner:** 优化 watch ([4c60cd6](https://github.com/NervJS/taro/commit/4c60cd6875d654585298e17d1b44f9afd25d4665))
* **mini-runner:** 保证快应用文件生成正确 ([0b2e882](https://github.com/NervJS/taro/commit/0b2e882306862a1da90014a43e558b5ba771a2d7))
* **mini-runner:** 加入 watch ([39ef6a9](https://github.com/NervJS/taro/commit/39ef6a92d2900a4da72214182fb5aef9b8969728))
* **mini-runner:** 增加 Taro 模块专有处理插件 ([5be50b0](https://github.com/NervJS/taro/commit/5be50b0bc92a8ba62607c63853567c55665459a5))
* **mini-runner:** 支持与原生小程序代码混写 ([f949253](https://github.com/NervJS/taro/commit/f949253297e29809b68b2e58c7198cf1d46e9f82))
* **mini-runner:** 支持分包 ([6240933](https://github.com/NervJS/taro/commit/6240933986b17d2036ba69cc3e00035fe411a344))
* **taro:** cli 配合 mini-runner 重构 && 支持使用 mini-runner 编译插件 ([3d3f620](https://github.com/NervJS/taro/commit/3d3f620e9b0e2acf9ca189915483d3d755c8a164))
* **taro-cli:** 配置文件分开存放，优化 taro config 输出 ([a641649](https://github.com/NervJS/taro/commit/a641649edf757bea7f76d5fa905f593c1717b98e))
* **taro-runner-utils:** 添加 @tarojs/runner-utils 包 ([12e1a24](https://github.com/NervJS/taro/commit/12e1a24b1740627cb93688d74bb348f08b452838))
* audio context ([f1f27c3](https://github.com/NervJS/taro/commit/f1f27c32b5e2fc7174246b6fbfc7757e14569d88))
* mock for quickapp ([2117035](https://github.com/NervJS/taro/commit/21170356eaf421a4ee229b23d994d09f35daaff3))
* stop trans asset for quickapp ([63087de](https://github.com/NervJS/taro/commit/63087de50811fdff33443f998c4fb56db0f363b0))
* **mini-runner:** 支持编译 tabBar 上引用的资源编译 ([c19ec85](https://github.com/NervJS/taro/commit/c19ec85c92455151046f1b2f2a3317c0ecc952e8))
* **mini-runner:** 生成快应用页面及组件 ([5e33381](https://github.com/NervJS/taro/commit/5e33381bf37ebccef6abcf008bf03539bcba8330))
* **taro:** 加入快应用编译支持 ([58d61c4](https://github.com/NervJS/taro/commit/58d61c485e1d50b4903a4d5c479f87185d13dfe2))
* **taro:** 调整小程序和 H5 的编译配置 ([e7134e6](https://github.com/NervJS/taro/commit/e7134e6d83d14ca65689b296b19794a0fa43db26))
* **taro-cli:** 调整 rn 编译配置 ([8d6f9b3](https://github.com/NervJS/taro/commit/8d6f9b32fd51ceb12528b38ddd61a0a96c1ae054))
* **taro-mini-runner:** 优化文件生成 ([cbf44a5](https://github.com/NervJS/taro/commit/cbf44a57594201f5637f0ae2a334d8a419977e40))
* **taro-mini-runner:** 如果是组件需要补充 component:true 配置 ([77cbbc6](https://github.com/NervJS/taro/commit/77cbbc6e11ab7809b4f0e18b54a1a9c36fbc5ae5))
* **taro-mini-runner:** 引入拆分的公共 chunks ([d46139f](https://github.com/NervJS/taro/commit/d46139fba010ff44d1c44339cbced77ca3ddeacf))
* **taro-mini-runner:** 拆分文件编译成为 plugin ([5280c05](https://github.com/NervJS/taro/commit/5280c05935b8293b86bc1dd9cbb347b3d64f4441))
* **taro-mini-runner:** 生成多端类型文件 ([cdbe7a9](https://github.com/NervJS/taro/commit/cdbe7a90bb60049d630f83afcdfaa4c366c420e2))
* **taro-mini-runner:** 生成页面以及组件的 usingComponents 配置 ([028f22c](https://github.com/NervJS/taro/commit/028f22cb168f67ec6f414dd97473a66c436191c6))
* checkout from auto-docs ([c9a5eaa](https://github.com/NervJS/taro/commit/c9a5eaa5d126df36e59917e3231edf9e35764460))
